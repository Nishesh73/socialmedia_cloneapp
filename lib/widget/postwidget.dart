  ...
  videoPlay() {
    if (widget.postModel.type == "video") {
      videoPlayerController =
          VideoPlayerController.network(widget.postModel.url);
      ...
      child: Column(
        children: [
          ListTile(
            ...
            trailing: widget.postModel.username == approvider.user
                ? null
                : GestureDetector(
                    onTap: () {
                      String? temporaryfriend =
                          approvider.user; //google signin wala mah
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => MyComment(
                                  ...
                                  descriptions: widget.postModel.description,
                                )));
                  },
